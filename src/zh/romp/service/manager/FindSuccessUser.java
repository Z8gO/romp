...
public class FindSuccessUser extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getSession().setAttribute("userSuccessPageBean", pageBean);
		response.sendRedirect("PageSkip?page=manager/manageuser.jsp");
