...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Answer</span>Question</h2>
          <div class="clr"></div>
          <p>感谢您的分享，请您尽量提交更详细的信息!</p>
          <img src="<%=request.getContextPath()%>${onequestion.imgpath}"  style="width:210px;height: 200px; "alt="image" />
          <div  class="upload"><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
          <hr/>
          <span>请您录入以下信息</span><span style="color:red;">(若相关信息不知道，则请填“暂无”)</span>
          <form  method="post"  action="QueToInfo"  onsubmit="return checkPlan()">
         <span>中文名　：</span><input type="text"  onblur="rexplanname()"  id="zwword"   name="zwword"/><span  id="mes2"></span><br/>
  		 ...
  		 <input  style="visibility: hidden;" type="text"   id="image"   name="imagepath"  value="${onequestion.imgpath}"/><br/>
  		 <input  style="visibility: hidden;" type="text"   id="pimguid"   name="pimguid"  value="${onequestion.uid}"/>
  		 <input  style="visibility: hidden;" type="text"   id="imgid"   name="imgid"  value="${onequestion.imgid}"/>
  		 <br/><br/>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="PageSkip?page=researcher/uploadNewPlant.jsp">上传新的植物</a></li>
