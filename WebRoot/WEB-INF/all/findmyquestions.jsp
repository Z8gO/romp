...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
       <ul>
        <li class="active"><a href="javascript:void(0)">尊敬的教学人员，${sessionScope.user.uname}，欢迎您登录</a></li>
    ...
    <div class="content_resize">
      ...
      <!--/search -->
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="PassQue?pc=1&pimguid=${sessionScope.user.uid}">查看已解决问题</a></li>
            <li><a href="NotPassQue?pc=1&uid=${sessionScope.user.uid}">查看未解决问题</a></li>
