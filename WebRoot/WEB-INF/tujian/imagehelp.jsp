...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
       <ul>
        <li ><a href="javascript:void(0)">尊敬的：${sessionScope.user.uname}，您的疑问就是我们的疑问！</a></li>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div  class="upload">
          <hr/>
          <span>请您上传您发现的植物照片：</span><br/><br/>
          <form  enctype="multipart/form-data"  method="post" 
           action="UpLoadQuestion"  name="upload" 
           onsubmit="return checkPlanjian()">
  		 <span>上传图片:</span><input name="image" type="file"  
  		  id="image" 	  onchange="fileChange(this);"/><br/><br/>
  		 <span>备　注　：</span><input type="text"  id="bz"   name="bz"/><br/><br/><br/>
  		 <input type="submit"  class="upbut" value="确定" />
  		 <input type="reset" class="upbut" value="重填" /></form>
          </div>
        </div>
      </div>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="javascript:void(0)">传图求帮助</a></li>
